...
public class ConnectionFactory {
    ...
    public ConnectionFactory() throws IOException {
        patch = "banco/algoritmos.db"; //insira o caminho do arquivo .db
    ...
    public Connection getConnection() {
        try {
            if (Files.AreYouHere(patch)) {
                Connection con = DriverManager.getConnection(url);
                return con;
            } else {
                throw new SQLException("O arquivo do banco de dados não foi encontrado");
            }
